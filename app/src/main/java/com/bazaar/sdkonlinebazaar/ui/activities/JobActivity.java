...
public class JobActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    private void getAllPersion() {
        ...
        try{
            ...
            Call<List<PersionResponse>> getpersionCall = RetrofitClient.getInstance().GetPersonByModuleId(2);
            getpersionCall.enqueue(new Callback<List<PersionResponse>>() {
                ...
                public void onResponse(Call<List<PersionResponse>> call, Response<List<PersionResponse>> response) {
                    ...
                    if (response != null) {
                       ...
                       /*     Log.d("List Result :", "index " + i);
                            ...
                            mMap.setOnMarkerClickListener(JobActivity.this);
                        ...
                        Toast.makeText(JobActivity.this, "Invalid Response ..!!", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<List<PersionResponse>> call, Throwable t) {
                    progressDialog.hideProgressDialog();
                    Utils.showSnackBar(JobActivity.this, "Something Went Wrong ..!!");

                    Toast.makeText(JobActivity.this, "Something Went Wrong ..!!" +t, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void signOut(View view) {
        ...
        JobActivity.this.startActivity(i);
    }
    ...
    private void init() {
        try {
            Constants.mFusedLocationClient = LocationServices.getFusedLocationProviderClient(JobActivity.this);
            Constants.mSettingsClient = LocationServices.getSettingsClient(JobActivity.this);
                ...
                updateResponseCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.body() != null) {
                            ...
                            Utils.showSnackBar(JobActivity.this, "Invalid user ..!!");
                        }
                    }
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(JobActivity.this, Constants.REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(JobActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                            }
    ...
    public void contectUstitleclick(View view){
        Intent intent = new Intent(JobActivity.this, ContactusActivity.class);
        startActivity(intent);
    }
    public void gotoFoodActivity(View view){
        Intent intent = new Intent(JobActivity.this, FoodActivity.class);
        startActivity(intent);
    }
    ...
    public void gotoMarrageActivity(View view){
        Intent intent = new Intent(JobActivity.this, MarrageActivity.class);
        startActivity(intent);
    }

    public void gotoEnterpreneurActivity(View view){
        Intent intent = new Intent(JobActivity.this, EnterpreneurActivity.class);
        startActivity(intent);
    }
    public void gotoBusinessActivity(View view){
