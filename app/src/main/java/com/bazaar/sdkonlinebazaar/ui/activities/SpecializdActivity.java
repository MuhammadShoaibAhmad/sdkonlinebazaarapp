...
public class SpecializdActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
        ...
        try{
            ...
            getpersionCall.enqueue(new Callback<List<PersionResponse>>() {
                ...
                public void onResponse(Call<List<PersionResponse>> call, Response<List<PersionResponse>> response) {
                    ...
                    if (response != null) {
                       ...
                       /*     Log.d("List Result :", "index " + i);
                            ...
                            mMap.setOnMarkerClickListener(SpecializdActivity.this);
                        ...
                        Toast.makeText(SpecializdActivity.this, "Invalid Response ..!!", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<List<PersionResponse>> call, Throwable t) {
                    progressDialog.hideProgressDialog();
                    Utils.showSnackBar(SpecializdActivity.this, "Something Went Wrong ..!!");

                    Toast.makeText(SpecializdActivity.this, "Something Went Wrong ..!!" +t, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void signOut(View view) {
        Intent i = new Intent(SpecializdActivity.this, LoginActivity.class);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        SpecializdActivity.this.startActivity(i);
    }
    ...
    private void init() {
        try {
            Constants.mFusedLocationClient = LocationServices.getFusedLocationProviderClient(SpecializdActivity.this);
            Constants.mSettingsClient = LocationServices.getSettingsClient(SpecializdActivity.this);
                ...
                updateResponseCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.body() != null) {
                            ...
                            Utils.showSnackBar(SpecializdActivity.this, "Invalid user ..!!");
                        }
                    }
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(SpecializdActivity.this, Constants.REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(SpecializdActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                            }
    ...
    public void eventprofileclick(View view){
        Intent intent = new Intent(SpecializdActivity.this, ProfileActivity.class);
        startActivity(intent);
    }

    public void contectUstitleclick(View view){
        Intent intent = new Intent(SpecializdActivity.this, ContactusActivity.class);
        startActivity(intent);
    }
    public void gotoFoodActivity(View view){
        Intent intent = new Intent(SpecializdActivity.this, FoodActivity.class);
        startActivity(intent);
    }
    public void gotoJobActivity(View view){
        Intent intent = new Intent(SpecializdActivity.this, JobActivity.class);
        startActivity(intent);
    }
    public void gotoMarrageActivity(View view){
        Intent intent = new Intent(SpecializdActivity.this, MarrageActivity.class);
        startActivity(intent);
    }
