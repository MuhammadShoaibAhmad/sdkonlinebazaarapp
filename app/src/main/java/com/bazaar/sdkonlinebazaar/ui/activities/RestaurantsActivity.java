...
public class RestaurantsActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
        ...
        try{
            ...
            getpersionCall.enqueue(new Callback<List<PersionResponse>>() {
                ...
                public void onResponse(Call<List<PersionResponse>> call, Response<List<PersionResponse>> response) {
                    ...
                    if (response != null) {
                       ...
                       /*     Log.d("List Result :", "index " + i);
                            ...
                            mMap.setOnMarkerClickListener(RestaurantsActivity.this);
                        ...
                        Toast.makeText(RestaurantsActivity.this, "Invalid Response ..!!", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<List<PersionResponse>> call, Throwable t) {
                    progressDialog.hideProgressDialog();
                    Utils.showSnackBar(RestaurantsActivity.this, "Something Went Wrong ..!!");

                    Toast.makeText(RestaurantsActivity.this, "Something Went Wrong ..!!" +t, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    private void init() {
        try {
            Constants.mFusedLocationClient = LocationServices.getFusedLocationProviderClient(RestaurantsActivity.this);
            Constants.mSettingsClient = LocationServices.getSettingsClient(RestaurantsActivity.this);
                ...
                updateResponseCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.body() != null) {
                            ...
                            Utils.showSnackBar(RestaurantsActivity.this, "Invalid user ..!!");
                        }
                    }
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(RestaurantsActivity.this, Constants.REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(RestaurantsActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                            }
    ...
    public void contectUstitleclick(View view){
        Intent intent = new Intent(RestaurantsActivity.this, ContactusActivity.class);
        startActivity(intent);
    }
    public void gotoFoodActivity(View view){
        Intent intent = new Intent(RestaurantsActivity.this, FoodActivity.class);
        startActivity(intent);
    }
    public void gotoJobActivity(View view){
        Intent intent = new Intent(RestaurantsActivity.this, JobActivity.class);
        startActivity(intent);
    }
    public void gotoMarrageActivity(View view){
        Intent intent = new Intent(RestaurantsActivity.this, MarrageActivity.class);
        startActivity(intent);
    }
