...
public class BusinessActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
    ...
    public void getAllPersion() {
        ...
        try{
            ...
            Call<List<PersionResponse>> getpersionCall = RetrofitClient.getInstance().GetPersonByModuleAndTypeId(1,4);
            getpersionCall.enqueue(new Callback<List<PersionResponse>>() {
                ...
                public void onResponse(Call<List<PersionResponse>> call, Response<List<PersionResponse>> response) {
                    ...
                    if (response != null) {
                       ...
                       /*     Log.d("List Result :", "index " + i);
                            ...
                            mMap.setOnMarkerClickListener(BusinessActivity.this);
                        ...
                        Toast.makeText(BusinessActivity.this, "Invalid Response ..!!", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<List<PersionResponse>> call, Throwable t) {
                    progressDialog.hideProgressDialog();
                    Utils.showSnackBar(BusinessActivity.this, "Something Went Wrong ..!!");

                    Toast.makeText(BusinessActivity.this, "Something Went Wrong ..!!" +t, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void signOut(View view) {
        ...
        BusinessActivity.this.startActivity(i);
    }
    ...
    private void init() {
        try {
            Constants.mFusedLocationClient = LocationServices.getFusedLocationProviderClient(BusinessActivity.this);
            Constants.mSettingsClient = LocationServices.getSettingsClient(BusinessActivity.this);
                ...
                updateResponseCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.body() != null) {
                            ...
                            Utils.showSnackBar(BusinessActivity.this, "Invalid user ..!!");
                        }
                    }
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(BusinessActivity.this, Constants.REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(BusinessActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                            }
    ...
    public void eventprofileclick(View view){
        Intent intent = new Intent(BusinessActivity.this, ProfileActivity.class);
        startActivity(intent);
    }

    public void contectUstitleclick(View view){
        Intent intent = new Intent(BusinessActivity.this, ContactusActivity.class);
        startActivity(intent);
    }
    public void gotoFoodActivity(View view){
        Intent intent = new Intent(BusinessActivity.this, FoodActivity.class);
        startActivity(intent);
    }
    public void gotoJobActivity(View view){
        Intent intent = new Intent(BusinessActivity.this, JobActivity.class);
        startActivity(intent);
    }

    public void gotoJobseekerActivity(View view){
        Intent intent = new Intent(BusinessActivity.this, JobseekerActivity.class);
        startActivity(intent);
    }
    public void gotoSpecializdActivity(View view){
        Intent intent = new Intent(BusinessActivity.this, SpecializdActivity.class);
        startActivity(intent);
    }
