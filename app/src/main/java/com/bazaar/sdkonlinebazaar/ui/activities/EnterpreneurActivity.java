...
public class EnterpreneurActivity extends FragmentActivity implements OnMapReadyCallback, GoogleMap.OnMarkerClickListener {
        ...
        try{
            ...
            getpersionCall.enqueue(new Callback<List<PersionResponse>>() {
                ...
                public void onResponse(Call<List<PersionResponse>> call, Response<List<PersionResponse>> response) {
                    ...
                    if (response != null) {
                       ...
                       /*     Log.d("List Result :", "index " + i);
                            ...
                            mMap.setOnMarkerClickListener(EnterpreneurActivity.this);
                        ...
                        Toast.makeText(EnterpreneurActivity.this, "Invalid Response ..!!", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(Call<List<PersionResponse>> call, Throwable t) {
                    progressDialog.hideProgressDialog();
                    Utils.showSnackBar(EnterpreneurActivity.this, "Something Went Wrong ..!!");

                    Toast.makeText(EnterpreneurActivity.this, "Something Went Wrong ..!!" +t, Toast.LENGTH_SHORT).show();
                }
            });
    ...
    public void signOut(View view) {
        Intent i = new Intent(EnterpreneurActivity.this, LoginActivity.class);
        i.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
        i.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        EnterpreneurActivity.this.startActivity(i);
    }
    ...
    private void init() {
        try {
            Constants.mFusedLocationClient = LocationServices.getFusedLocationProviderClient(EnterpreneurActivity.this);
            Constants.mSettingsClient = LocationServices.getSettingsClient(EnterpreneurActivity.this);
                ...
                updateResponseCall.enqueue(new Callback<String>() {
                    ...
                    public void onResponse(Call<String> call, Response<String> response) {
                        ...
                        if (response.body() != null) {
                            ...
                            Utils.showSnackBar(EnterpreneurActivity.this, "Invalid user ..!!");
                        }
                    }
                            ...
                            switch (statusCode) {
                                case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                    ...
                                    try {
                                        ...
                                        rae.startResolutionForResult(EnterpreneurActivity.this, Constants.REQUEST_CHECK_SETTINGS);
                                ...
                                case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                    ...
                                    Toast.makeText(EnterpreneurActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                            }
    ...
    public void eventprofileclick(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, ProfileActivity.class);
        startActivity(intent);
    }

    public void contectUstitleclick(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, ContactusActivity.class);
        startActivity(intent);
    }
    public void gotoFoodActivity(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, FoodActivity.class);
        startActivity(intent);
    }
    public void gotoJobActivity(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, JobActivity.class);
        startActivity(intent);
    }

    public void gotoJobseekerActivity(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, JobseekerActivity.class);
        startActivity(intent);
    }
    public void gotoSpecializdActivity(View view){
        Intent intent = new Intent(EnterpreneurActivity.this, SpecializdActivity.class);
        startActivity(intent);
    }
